...
public class Apple extends Fruit{
  final static int weight = 150;  // 1個あたりの重量
  final static double vitaminC = 4.0 * (weight/100.0);  // 1個あたりのVC量
  final static int price = 127; // 1個あたりの価格

  // 基底クラスのコンストラクタの呼び出し(個数を受け取る)
  public Apple(int amount){
    super(Apple.vitaminC, Apple.price, amount);
  }
}
